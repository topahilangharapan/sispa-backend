    ...
    public SecurityFilterChain jwtFilterChain(HttpSecurity http) throws Exception {
        http.securityMatcher("/api/**")
                ...
                .authorizeHttpRequests(requests -> requests
                        ...
                        .requestMatchers("/api/purchase-order/**").hasAnyRole("ADMIN", "MARKETING", "MANAGEMENT")
                        .requestMatchers("/api/invoice/**").hasAnyRole("ADMIN", "FINANCE", "MANAGEMENT")
                        .requestMatchers("/api/final-report/**").hasAnyRole("ADMIN", "MARKETING", "MANAGEMENT")
